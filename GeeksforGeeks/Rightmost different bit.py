...
representation of numbers. If both M and N are the same then return -1 in this case.
...
User Task:
The task is to complete the function posOfRightMostDiffBit() which takes two arguments M and N and returns the position 
of first different bits in M and N from right. If both m and n are the same then return -1 in this case.
